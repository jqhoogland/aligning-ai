...
:def[Cayley table]
This is called a **Cayley table**, and it's a useful way to visualize the group structure of a set of elements. Entry $(r,c)$ is what you get after applying the $c$th operation to the $r$th element. 
